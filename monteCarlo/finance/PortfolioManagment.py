...
portfolio_df.to_csv(f"{path}\\portfolio_results.csv", index=False)
...
print(f"Total Mean Simulated Value: ${total_mean_value:,.2f}")
print(f"Total Value-at-Risk (5th Percentile): ${total_risk_value_at_5th_percentile:,.2f}")
