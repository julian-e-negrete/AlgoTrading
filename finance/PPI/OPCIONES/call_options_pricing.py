...
def main():
    ...
    ## viewer of the list, and all the information of call contracts
    # flattened = []
    # for exp_date, options in sorted_grouped_data_calls.items():
    #     for opt in options:
    #         opt['grouped_expiration'] = exp_date
    ...
    for expiration_date, items in sorted_grouped_data_calls.items():
        ...
        for item in items:
            ...
            precio_opcion = market.get_market_data(item["ticker"].strip().upper(), "OPCIONES", "INMEDIATA")
